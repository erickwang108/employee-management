        ...
        `,
          {
            ...
            $dutyId: dutyId > 0 ? dutyId : 'NULL',
            $partyId: partyId > 0 ? partyId : 'NULL',
            $educationId: educationId > 0 ? educationId : 'NULL',
            $graduateId: graduateId > 0 ? graduateId : 'NULL',
            $majorId: majorId > 0 ? majorId : 'NULL',
            $workTypeId: workTypeId > 0 ? workTypeId : 'NULL',
            $employmentFormId: employmentFormId > 0 ? employmentFormId : 'NULL',
            $nationId: nationId > 0 ? nationId : 'NULL',
            $updateDate: tm,
